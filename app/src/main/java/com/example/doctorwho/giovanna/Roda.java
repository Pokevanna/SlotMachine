package com.example.johw.giovanna;
...
public class Roda extends Thread {
    ...
    private static int[] imagensSlots = {R.drawable.militariessanfrontiers_logo, R.drawable.metalgear_logo, R.drawable.foxhound_logo, R.drawable.diamonddogs_logo, R.drawable.metalgear_logo};
